  ...
  return (
    <DashboardLayout>
      <div className="max-w-4xl mx-auto px-6 py-8">
        {/* Professional Header */}
        <div className="mb-6">
          <h1 className="text-3xl font-sora font-bold text-white mb-2">Doctor Profile</h1>
          <p className="text-sm text-gray-400 font-roboto">View and edit your professional information</p>
        </div>
        ...
        >
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span className="text-sm font-medium text-white font-roboto">Doctor</span>
            </div>
            <div className="flex justify-between py-2.5"
              style={{ borderBottom: '1px solid rgba(100, 255, 218, 0.1)' }}
            >
