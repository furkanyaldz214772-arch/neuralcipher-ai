...
import { 
  ...
  ArrowUpRight, ArrowDownRight, Minus, ChevronDown, RefreshCw
} from 'lucide-react'
...
export default function PatientTestsPage() {
  ...
  useEffect(() => {
    applyFilters()
  }, [tests, searchQuery, filterStatus, sortBy])
            ...
            {filteredTests.map((test, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-gradient-to-br from-[#1E293B] to-[#0F172A] border border-gray-700/50 rounded-xl p-6 hover:border-[#0EA5E9]/50 transition-all cursor-pointer group"
