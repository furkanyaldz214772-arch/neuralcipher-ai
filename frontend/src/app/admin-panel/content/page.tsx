  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-lg transition-shadow cursor-pointer">
          <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center mb-4">
            <span className="text-2xl">🏠</span>
          </div>
          <h3 className="text-lg font-semibold text-slate-800 mb-2">Landing Page</h3>
          <p className="text-sm text-slate-600 mb-4">Edit hero, features, testimonials</p>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-lg transition-shadow cursor-pointer">
          ...
          <h3 className="text-lg font-semibold text-slate-800 mb-2">Blog Posts</h3>
          <p className="text-sm text-slate-600 mb-4">Manage blog articles</p>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-lg transition-shadow cursor-pointer">
          ...
          <h3 className="text-lg font-semibold text-slate-800 mb-2">Pages</h3>
          <p className="text-sm text-slate-600 mb-4">About, Contact, Terms, Privacy</p>
          <button className="text-purple-600 hover:text-purple-700 text-sm font-medium">Edit →</button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        <h3 className="text-lg font-semibold text-slate-800 mb-4">Recent Blog Posts</h3>
