        ...
        <div className="bg-slate-800 rounded-xl shadow-sm border border-slate-700 p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input type="text" className="w-full px-4 py-2 bg-slate-700 border border-slate-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Email subject..." />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-200 mb-2">Message</label>
              <textarea rows={6} className="w-full px-4 py-2 bg-slate-700 border border-slate-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Email message..."></textarea>
            </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="p-4 bg-slate-700/50 rounded-lg">
                ...
                <p className="text-sm text-slate-400">{email.recipients} recipients • {email.sent}</p>
              </div>
            ))}
          </div>
        </div>
