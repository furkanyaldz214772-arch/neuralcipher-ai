              ...
              <div className="mb-6">
                ...
                <div className="flex items-center justify-center gap-4">
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="w-12 h-12 rounded-xl bg-white hover:bg-gray-100 flex items-center justify-center transition-all shadow-lg cursor-pointer relative z-10"
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="w-12 h-12 rounded-xl bg-[#0078D4] hover:bg-[#106EBE] flex items-center justify-center transition-all shadow-lg opacity-50 cursor-not-allowed"
                    disabled
                  >
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="w-12 h-12 rounded-xl bg-[#0A66C2] hover:bg-[#004182] flex items-center justify-center transition-all shadow-lg opacity-50 cursor-not-allowed"
                    disabled
                  >
                    <svg className="w-5 h-5" fill="white" viewBox="0 0 24 24">
