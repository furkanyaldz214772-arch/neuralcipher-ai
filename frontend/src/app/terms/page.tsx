/**
 * NeuralCipher.ai - Terms of Service Page
...
import { FiShield, FiCheckCircle, FiAlertTriangle, FiMail, FiArrowLeft, FiArrowRight, FiGlobe, FiHeart } from 'react-icons/fi'
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#64FFDA]/10 border border-[#64FFDA]/30 mb-6">
              ...
              <span className="text-sm text-[#64FFDA] font-semibold">Legal Information</span>
            </div>
          ...
          >
            ...
            <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/30 rounded-xl p-6">
              <div className="flex items-start gap-4">
                <FiAlertTriangle className="text-yellow-400 text-2xl flex-shrink-0 mt-1" />
                <div>
                  <h3 className="text-xl font-bold text-yellow-400 mb-2">Important Medical Disclaimer</h3>
                  <p className="text-gray-300 leading-relaxed">
                    NeuralCipher.ai is <strong>not a medical device</strong> and does not provide medical diagnosis. 
                    Our AI-powered voice analysis is for <strong>screening purposes only</strong>. Always consult 
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Service Description</h3>
                  <p className="text-gray-300 leading-relaxed">
                    NeuralCipher.ai provides AI-powered voice analysis for Parkinson's disease screening. 
                    The service analyzes voice patterns to identify potential early indicators, assisting 
                    healthcare providers in early detection efforts.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    We are committed to protecting your health data in compliance with HIPAA regulations. 
                    All voice recordings and analysis results are encrypted and securely stored. 
                    See our{' '}
                    <Link href="/privacy" className="text-[#64FFDA] hover:text-[#3B82F6] transition-colors underline">
                      Privacy Policy
                    </Link>
                    {' '}for details.
                  </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    NeuralCipher.ai provides screening tools only. We are not liable for medical decisions 
                    made based on our analysis. Always seek professional medical advice for health concerns.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-gray-800 pt-8">
              <div className="flex items-center gap-3 text-gray-300">
                ...
                <span>Questions? Contact us at{' '}
                  <a href="mailto:legal@neuralcipher.ai" className="text-[#64FFDA] hover:text-[#3B82F6] transition-colors">
                    legal@neuralcipher.ai
                  </a>
                </span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-xl bg-[#64FFDA]/10 flex items-center justify-center">
                  <FiCheckCircle className="text-[#64FFDA] text-2xl" />
                </div>
                <h3 className="text-xl font-bold text-white">Acceptance of Terms</h3>
              </div>
              <p className="text-gray-300 leading-relaxed text-sm">
                By accessing and using NeuralCipher.ai, you acknowledge that you have read, understood, 
                and agree to be bound by these Terms of Service. If you do not agree, please discontinue use immediately.
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-xl bg-[#3B82F6]/10 flex items-center justify-center">
                  <FiShield className="text-[#3B82F6] text-2xl" />
                </div>
                <h3 className="text-xl font-bold text-white">Account Security</h3>
              </div>
              <p className="text-gray-300 leading-relaxed text-sm">
                You are responsible for maintaining the confidentiality of your account credentials. 
                Enable two-factor authentication for enhanced security. Report any unauthorized access immediately.
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-xl bg-[#8B5CF6]/10 flex items-center justify-center">
                  <FiHeart className="text-[#8B5CF6] text-2xl" />
                </div>
                <h3 className="text-xl font-bold text-white">Intellectual Property</h3>
              </div>
              <p className="text-gray-300 leading-relaxed text-sm">
                All content, features, and functionality are owned by NeuralCipher.ai and protected by 
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-xl bg-[#64FFDA]/10 flex items-center justify-center">
                  <FiAlertTriangle className="text-[#64FFDA] text-2xl" />
                </div>
                <h3 className="text-xl font-bold text-white">Termination Rights</h3>
              </div>
              <p className="text-gray-300 leading-relaxed text-sm">
          ...
          >
            ...
            <div className="space-y-4">
              <div className="border-b border-gray-800 pb-4">
                <h4 className="text-white font-bold mb-2">Can I use the service for medical diagnosis?</h4>
                <p className="text-gray-400 text-sm">
                  No. NeuralCipher.ai is a screening tool only. Always consult qualified healthcare professionals for diagnosis and treatment.
                </p>
              </div>
              <div className="border-b border-gray-800 pb-4">
                <h4 className="text-white font-bold mb-2">What happens to my voice recordings?</h4>
                <p className="text-gray-400 text-sm">
                  All recordings are encrypted and stored securely in HIPAA-compliant infrastructure. You can delete your data at any time.
                </p>
              </div>
              <div className="border-b border-gray-800 pb-4">
                <h4 className="text-white font-bold mb-2">Can I cancel my subscription?</h4>
                <p className="text-gray-400 text-sm">
                  Yes. You can cancel anytime from your account settings. No questions asked, no cancellation fees.
                </p>
              </div>
              <div>
                <h4 className="text-white font-bold mb-2">How do I report a terms violation?</h4>
                <p className="text-gray-400 text-sm">
                  Contact us at <a href="mailto:legal@neuralcipher.ai" className="text-[#64FFDA] hover:text-[#3B82F6]">legal@neuralcipher.ai</a> with details of the violation.
                </p>
              </div>
            </div>
          </motion.div>
